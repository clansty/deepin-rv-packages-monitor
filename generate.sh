...
wget http://deb.debian.org/debian-ports/dists/sid/main/binary-riscv64/Packages.xz -O tools/convert/Packages-sid-rv.xz
unxz tools/convert/Packages-sid.xz
unxz tools/convert/Packages-sid-rv.xz
